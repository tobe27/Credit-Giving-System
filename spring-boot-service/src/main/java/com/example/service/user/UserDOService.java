...
public interface UserDOService {
     ...
     * @throws Exception
     */
    String getTaskDate() throws Exception;
     ...
     * @throws Exception
     */
    List<Long> listUserIdByOrgCode(UserDO record, Integer pageNum, Integer pageSize) throws Exception;
     ...
     * @throws Exception 数据库异常
     */
    boolean updateFieldById(UserDO record) throws Exception;
}
